  ...
  return (
    <div className="md:mt-[150px] mt-[150px] relative">
      ...
      <div className="flex md:flex-row flex-col-reverse flex-col w-[90%] md:justify-between md:mx-auto md:items-center">
        ...
        <Image src="/imge/home/EXBRO.webp" alt="EX-PRO" width={560} height={331} loading="lazy" data-aos="fade-out" sizes="(max-width: 768px) 90vw, 45vw" className="z-5 mx-auto md:mx-0 w-full md:max-w-[45%] max-w-[560px] h-auto" />
      </div>
