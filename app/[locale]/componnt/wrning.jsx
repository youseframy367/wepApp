...
export default function Worning ({textAr , textEn ,className ,textSpanAr='' ,textSpanEn='' , styleSpan}){
    const local=useLocale()
    return(
        <GradientBorderBox className={` ${className}  w-[90%] mx-[auto] md:h-[68px] h-auto flex md:gap-[24px] gap-[15px] items-center px-[20px]`}>
