    ...
    <div>
      ...
      />
          ...
          <div className="flex flex-col md:gap-[5px]">
            <h1  className={`md:font-[600] font-[500] md:text-[60px] text-[30px] text-primary ${locale === "en" ?"font-montserrat":"font-cairo"}`}>
              {t("title")}
            </h1>

            <p  className={`font-[400]  ${locale === "en"?"font-inter md:text-[16px] text-[14px]":"font-cairo md:text-[18px] text-[16px]"} tracking-[-0.25px]`}>
              {t("subtitle")}
            </p>
          </div>
        </div>
      ...
      />
        ...
        <p  className={`font-[400] md:text-[14px] text-[12px] leading-[21px] ${locale === "en" ? "font-inter" :"font-cairo font-[500] text-[16px] leading-[26px]"}  tracking-[-0.25px]`}>
          {t("notice")}
        </p>
      </GradientBorderBox>

      <p  className={`${locale === "en" ?"font-inter":"font-cairo font-[500]"} font-[400] md:text-[12px] text-[12px] tracking-normal-[-0.25px] my-[10px] text-center md:w-auto w-[90%] mx-auto`}>
        {t("footer")}
      </p>
    </div>
  );
