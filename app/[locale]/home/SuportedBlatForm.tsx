  ...
  return (
    <div className="w-[90%] mx-auto my-[40px]">
      ...
      <div className="flex flex-col items-center  relative">
        <Image src="/imge/effect.webp" alt="effect" width={1280} height={509} loading="lazy"  className="absolute md:top-[20%] top-[10%] scale-x-[-1] left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none" />
        <div
