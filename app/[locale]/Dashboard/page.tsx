...
export default function Dashboard() {
  ...
  return (
    <div className="text-center flex flex-col gap-[10px] relative">
      ...
      <h1  className="font-montserrat font-[700] md:mt-[100px] mt-[70px] md:text-[70px] text-[60px] text-primary-animated items-center">
        {t("title")}
      </h1>
      <h2  className={`font-[500] mt-[-10px] md:text-[30px] text-[25px] ${fontClass} tracking-[-0.25px] leading-[24px] text-primary-mid items-center`}>
        {t("subtitle")}
      </h2>
      <p  className={`${locale === "en" ? "font-inter font-[600]" : "font-cairo font-[500]"} md:text-[16px] text-[14px] leading-[22px] tracking-[-0.25px]`}>
        {t("tagline")}
      </p>
      <p  className={`md:w-[700px] w-[90%] mx-auto ${fontClass} font-[400] md:text-[16px] text-[14px] tracking-[-0.25px] leading-[24px]`}>
        {t("description")}
      </p>
      <Image  src="/imge/home/EXBRO.webp" alt="EX-PRO" width={560} height={331} sizes="(min-width: 768px) 560px, 90vw" className="z-5 mx-auto md:w-[560px] w-[90%] h-auto" />
      <button
      ...
      <div className="flex text-center items-center justify-center gap-2 md:gap-3 my-3 px-4" >
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 mt-[20px] w-[90%] mx-auto gap-[20px] text-start relative">
        ...
        {DashboardData.map((item) => (
          <BlackBox borderEfect={false} key={item.key} className="flex gap-[15px] items-center w-[100%] p-[10px]">
            <Image src={item.img} alt={item.key} width={114} height={110} className="md:w-auto w-[80px] h-auto"  />
      ...
      <BlackBox borderEfect={false} className="flex gap-[15px] items-center w-[100%] py-[20px] px-[30px] w-[90%] mx-auto text-start my-[20px]">
        <Image src="/imge/worning.webp" alt="Notice" width={42} height={34}  />
        <div className="flex flex-col gap-[10px]" >
          <h2 className={`font-[500] ${locale === "en" ? "font-montserrat" : "font-cairo"} md:text-[20px] text-[18px] text-primary-dark`}>
            {t("notice.title")}
          </h2>
